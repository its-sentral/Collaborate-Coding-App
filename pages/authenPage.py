...
class Authen(QMainWindow):
    def __init__(self):
        ...
        # --- FIX: Make QStackedWidget Stretch ---
        # 1. Create a container and a layout
        ...
        # 2. Add the StackedWidget to the layout
        self.main_layout.addWidget(self.ui.MainPages)
        
        # 3. Set the container as the actual Central Widget of the Window
